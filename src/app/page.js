...
export default function Home() {
  ...
  const onSubmit = (data) => {
    ...
    setBillCalculation(
      <>
        <div>
          <p className="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-100">
            Bill Calculation
          </p>
          <div className="bg-gray-200 px-4 py-2.5 rounded-md w-full dark:bg-gray-700">
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
      ...
      <div className="w-full bg-gray-50 rounded-md shadow-md dark:shadow-md md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 border dark:border-gray-800">
                ...
                render={({ field }) =>
                  <input
                    ...
                    className={classNames(
                      "bg-white border border-gray-300 dark:border-slate-800 dark:bg-gray-700 dark:text-gray-200 focus:outline-none text-gray-900 sm:text-sm rounded-md block w-full px-3 py-2",
